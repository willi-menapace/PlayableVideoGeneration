...
class RenderingNetwork(nn.Module):
    ...
    def __init__(self, config):
        ...
        upsample_block_list = [
            nn.Sequential(UpBlock(64, 64, scale_factor=2, upscaling_mode="bilinear"),  # res * 4
                          ResidualBlock(64, 64, downsample_factor=1)),
            nn.Sequential(UpBlock(64, 32, scale_factor=2, upscaling_mode="bilinear"),  # res * 8
                          ResidualBlock(32, 32, downsample_factor=1)),
            UpBlock(32, 16, scale_factor=2, upscaling_mode="bilinear"),  # res * 16
        ]

        final_block_list = [
            FinalBlock(64, 3, kernel_size=3, padding=1),
            FinalBlock(32, 3, kernel_size=3, padding=1),
            FinalBlock(16, 3, kernel_size=7, padding=3)
        ]
